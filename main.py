...
group_dataset.add_argument('--sample_nums', type=int, default=200,
...
try:
    ...
    train(logger=logger, net=model, optimizer=optimizer, criterion=loss, train_loader=train_loader,
          ...
          device=hyperparams['device'], supervision=hyperparams['supervision'], val_loader=val_loader, vis_display=vis)
